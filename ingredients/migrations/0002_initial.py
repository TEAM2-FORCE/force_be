...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_products', to='products.product', verbose_name='성분을 포함하는 상품들'),
        ),
        migrations.AddField(
            model_name='bookmark',
            name='igd',
